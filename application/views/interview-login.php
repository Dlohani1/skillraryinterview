...
<div class="col-md-8 offset-md-2 googleLoginContainer">
  <h4 style="text-align:center" class="headingLogin">SkillRary Interview Login</h4><br/>
  <?php if (isset($_SESSION['error'])) { echo "<p style='color: red;
    ...
    <div class="container">
      <div class="col-lg-5 offset-md-2">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url().'user/signin';?>">
          ...
          <div class="row" style="display: none">
            <div class="col-md-9">           
              <select class="form-control inputSocial" style="height: 50px;" id="login-for" name="login-for">
                <option value="1" > Take Assessment </option>
                <option value="2" selected> Take Interview </option>
              </select>
            </div>
          </div>
