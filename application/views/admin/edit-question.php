...
<div class="form-group" id="singleOptions" >
    ...
    <div class="col-md-8">     
        ...
        <input type="radio" <?php if ($questionData['options'][0]['correct']) {echo "checked";} ?> name="correct" value="1"> Select if correct option


        <input type="text" class="form-control" id="option1" value='<?php echo $options_0;?>' name="ans1">
