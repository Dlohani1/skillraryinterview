                    ...
                    <form name="fstForm" action="#">
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                <label class="labelColor">Drive Details</label>  (optional)
                                <input type="date" name="drive-date" class="form-control" id="drive-date" placeholder="Enter Date">
                                <br/><input type="time" name="drive-time" class="form-control" id="drive-time" placeholder="Enter time  (optional)">
                       ...
                       <!--  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                <label class="labelColor">Title<span style="color:red">*</span></label>
    ...
    $('#customerList').fadeOut();
            ...
            function firstForm() {
                ...
                // if (document.getElementById("title").value.trim().length > 0 && customerCode.length > 0) {
                    $.ajax({
                    url: baseUrl+"/customer/addTest",
                   
                    type: 'post',
                    
                    // data: { "test-title": $('#testTitle').val(), "test-type": $('#testType').val() } ,
                    data: { "test-title": $('#title').val(), "test-type": 2, "drive-date": $('#drive-date').val(), "drive-time": $('#drive-time').val(), "drive-place": $('#drive-place').val() } ,
                    success: function( data, textStatus, jQxhr ){
                        //$('#response pre').html( JSON.stringify( data ) );
                        console.log('data', data);
            ...
            function secondFormSubmit() {
               ...
               var noId = document.getElementsByClassName("item_unit");
                ...
                $.ajax({
                    url: baseUrl+"/customer/addTestTime",
                    type: 'post',
                    ...
                    success: function( data ){
                      //  $('#response pre').html( JSON.stringify( data ) );
                        console.log('data', data);
                        window.location.href= baseUrl+"customer/mcq-list";
