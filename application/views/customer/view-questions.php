        ...
        foreach($questionData as $key => $value) {
           $i++;
            ...
            echo '<tr><td>'.$i.'</td>
                    ...
                    'customer/edit-question/'.$id.'"><button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></button></a></p></td>
...
$( document ).ready(function() {
  ...
  function getSubSection() {
    ...
    $('#back').click(function () {
      ...
      let url =  baseUrl+"customer/view-questions";
